...
import os, math, traceback, datetime, argparse, requests, json

def helpmsg():
    p = argparse.ArgumentParser()
    p.add_argument("g", help = "a gwas output ending in .csv (preferably from gapit)")
    p.add_argument("a", help = "annotation file ending in .txt from a database")
    args = p.parse_args()
    print(args.g)
    print(args.a)
